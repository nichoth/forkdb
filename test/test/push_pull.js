...
test('push pull verify', async function (t) {
    ...
    forkdb1.list(function (_err, hs) {
        t.ifError(_err);
        t.deepEqual(mhashes(hs).sort(), [hashes[0], hashes[2]].sort(), 'list a');
    });
    ...
    forkdb2.list(function (_err, hs) {
        t.ifError(_err);
        t.deepEqual(mhashes(hs).sort(), [hashes[0], hashes[1], hashes[2], hashes[3]].sort(), 'list b');
    });
});
function mhashes(xs) { return xs.map(function (x) { return x.hash; }); }
//# sourceMappingURL=push_pull.js.map